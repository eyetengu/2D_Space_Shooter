...
//Enemy Speed Parameters
    ...
    void Start()
    {
        ...
        //set the EnemyContainer as parent
        ...
        //assign the variables(_gameCameraAnimator, _player, _soundManager)
        ...
        //assign this enemy's components
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if(other.tag == "Player")
        {
            ...
            //_gameCameraAnimator.ResetTrigger("CameraShake_bool");
        ...
        if(other.tag == "Laser")
        {
            ...
            else if (_enemyShieldActive == false)
            {
                ...
                _animator.SetTrigger("OnEnemyDeath");
                _animator.SetTrigger("AsteroidExplosion");
